...
import CallTimer from "../components/orders/Ex";
...
import DIDPurchaseRequestList from "../components/did/DIDPurchaseRequestList";
...
export default function adminRoutes() {
  return (
    <>
      ...
      <Route path="DIDPurchaseRequest" element={<DIDPurchaseRequestList/>} />
      <Route path="ex" element={<CallTimer/>} />
